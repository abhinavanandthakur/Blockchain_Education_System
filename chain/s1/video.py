...
user_input = int(
    input("Press 1 to to watch Array Video and any other key to Exit:"))

if(user_input == 1):
    webbrowser.open("https://www.youtube.com/watch?v=0EgpeYB115s")

else:
    exit(0)

user_input = int(input(
    "Press 1 to to take a quiz after you've finished watching the video, press any other key to exit: "))
